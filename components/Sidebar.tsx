        ...
        <div className="bg-slate-900/50 rounded-3xl p-5 border border-slate-800/50 mb-4">
          <div className="flex items-center gap-3">
            ...
            <div className="overflow-hidden">
              ...
              <p className={`text-[9px] uppercase tracking-widest font-bold ${isSuperUser ? 'text-violet-400' : isAdmin ? 'Administrador' : 'Operario'}`}>{isSuperUser ? 'Super Usuario' : isAdmin ? 'Administrador' : 'Operario'}</p>
            </div>
          </div>
        </div>
        <button
